<?php
// source: D:\www\aa\app/config/config.neon 
// source: D:\www\aa\app/config/config.local.neon 

class Container_4e102274e6 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\aa\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\aa\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\aa\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_4e102274e6_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_4e102274e6_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_4e102274e6 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\aa\app/../temp/cache/latte');
