<?php
// source: H:\Michal\www\android-project-server\app/config/config.neon 
// source: H:\Michal\www\android-project-server\app/config/config.local.neon 

class Container_55b1d5dcab extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'H:\Michal\www\android-project-server\app',
			'wwwDir' => 'H:\Michal\www\android-project-server\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'H:\Michal\www\android-project-server\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'H:\Michal\www\android-project-server\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('H:\Michal\www\android-project-server\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('H:\Michal\www\android-project-server\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_55b1d5dcab $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('H:\Michal\www\android-project-server\app/../temp/cache/latte');
