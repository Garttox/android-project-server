<?php
// source: /home/michal/www/android-project-server/app/config/config.neon 
// source: /home/michal/www/android-project-server/app/config/config.local.neon 

class Container_219215b8e6 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\ApiPresenter' => [1 => ['application.5']],
			'App\Presenters\ListPresenter' => [1 => ['application.6']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.7']],
		...
		'services' => [
			...
			'application.5' => 'App\Presenters\ApiPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/home/michal/www/android-project-server/app',
			'wwwDir' => '/home/michal/www/android-project-server/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/michal/www/android-project-server/app/../temp',
		];
	}
	...
	public function createServiceApplication__5(): App\Presenters\ApiPresenter
	{
	...
	public function createServiceApplication__7(): App\Presenters\ErrorPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/michal/www/android-project-server/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/home/michal/www/android-project-server/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/michal/www/android-project-server/app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_219215b8e6 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/michal/www/android-project-server/app/../temp/cache/latte');
