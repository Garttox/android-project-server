<?php
// source: E:\SchoolProject\android-project-server\app/config/config.neon 
// source: E:\SchoolProject\android-project-server\app/config/config.local.neon 

class Container_95b7411670 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'E:\SchoolProject\android-project-server\app',
			'wwwDir' => 'E:\SchoolProject\android-project-server\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'E:\SchoolProject\android-project-server\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\SchoolProject\android-project-server\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('E:\SchoolProject\android-project-server\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\SchoolProject\android-project-server\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_95b7411670 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\SchoolProject\android-project-server\app/../temp/cache/latte');
