<?php
// source: H:\Michal\www\android-project-server\app\presenters\templates\components\bootstrap-up-form.latte

use Latte\Runtime as LR;

class Template8c3c26dcc3 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
		...
		echo end($this->global->formsStack)["email"]->getControl()->addAttributes(['class' => "form-control col-md-4"]) /* line 17 */ ?>
		...
		echo end($this->global->formsStack)["password"]->getControl()->addAttributes(['class' => "form-control col-md-4"]) /* line 20 */ ?>

		</div>
		<div class="form-group row">
			<?php echo end($this->global->formsStack)["send"]->getControl()->addAttributes(['class' => "btn btn-primary offset-md-5"]) /* line 23 */ ?>
