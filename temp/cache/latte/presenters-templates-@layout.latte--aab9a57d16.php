<?php
// source: C:\xampp\htdocs\android-project-server\app\presenters/templates/@layout.latte

use Latte\Runtime as LR;

class Templateaab9a57d16 extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
		'header' => 'blockHeader',
...
<nav class="navbar navbar-expand-sm bg-primary text-white d-none d-md-flex">
	...
	<li class="nav-item">
            <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:howItWorks")) ?>"> Jak to funguje?</a>
    	</li>
    	<li class="nav-item">
            <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:faq")) ?>"> FAQ</a>
    	</li>
    	<li class="nav-item">
            <a class="nav-link text-white" href="https://play.google.com/store" target="_blank"> Stáhnout</a>
    	</li>
    </ul>
    <!-- Dropdown -->
...
?>
    	<li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" id="navbardrop" data-toggle="dropdown"> <?php
...
<?php
			if ($user->isAllowed('List', 'default')) {
				?>                <a class="dropdown-item text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>"> Seznam Stezek</a>
                <hr>
                <a class="dropdown-item text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>"> Upravit Stezku</a>
                <hr>
<?php
			}
			if ($user->isAllowed('List', 'add')) {
				?>        	<a class="dropdown-item text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>"> Přidat Stezku</a>
                <hr>
<?php
			}
...
<nav class="navbar bg-primary text-center text-white d-md-none">
    <!-- Dropdown -->       
            ...
            <div class="collapse navbar-collapse text-center" id="myNavbar">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>">Profiles</a>
                    </li>
                    <hr class="menuhr">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>">Games</a>
                    </li>
                    <hr class="menuhr">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>">Achievements</a>
                    </li>
                    <hr class="menuhr">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:default")) ?>">Guides</a>
                    </li>
                </ul>
            </div>
</nav>
...
<?php
		...
		foreach ($flashes as $flash) {
			...
			echo LR\Filters::escapeHtmlText($flash->message) /* line 103 */ ?></div>
<?php
			$iterations++;
		}
...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['flash'])) trigger_error('Variable $flash overwritten in foreach on line 103');
