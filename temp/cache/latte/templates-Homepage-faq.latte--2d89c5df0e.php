<?php
// source: D:\www\android-project-server\app\presenters/templates/Homepage/faq.latte

use Latte\Runtime as LR;

class Template2d89c5df0e extends Latte\Runtime\Template
{
	public $blocks = [
        ...
        <div class="accordion" id="accordionExample">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-justify">
                                ...
                                <p align="left"><a href="https://github.com/garttox">Github</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header" id="headingFour">
                        <p class="left">Kde najdu QR kódy spojené s touto aplikací?</p>
                        <button class="btn btn-link right" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                            <i class="fas fa-plus"></i>
                        </button>
                </div>
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                    <div class="card-body">
                        <p class="text-justify">V tuto chvíli nenaleznete QR kódy nikde, jelikož projekt není stoprocentě hotový, tudíž nemáme možnost jej předat či navrhnout městu, které tudíž nemůže přejít k tisku a vystavení QR kódů.</p>
                        <p class="text-justify">Po dokončení projektu a případném prezentaci městu či kulturní organizaci budou QR kódy k nalezení v místě jimi určeném.</p>
                    </div>
                </div>
            </div>
        </div>
