<?php
// source: H:\Michal\www\android-project-server\app\presenters/templates/List/users.latte

use Latte\Runtime as LR;

class Templateed666126d0 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
                            ...
                            <tr class="table"<?php echo ' id="' . htmlSpecialChars($this->global->snippetDriver->getHtmlId("row-$id")) . '"' ?>>
<?php
			...
			?>                                <td><?php echo LR\Filters::escapeHtmlText($row['username']) /* line 14 */ ?></td>
                                ...
                                <td>
                                    <a class="btn btn-primary ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("role!", [$id])) ?>"><?php
			if ($row['role'] == 'admin') {
				?>Demote<?php
			}
			else {
