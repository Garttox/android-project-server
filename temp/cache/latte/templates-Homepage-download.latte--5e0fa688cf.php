<?php
// source: D:\www\android-project-server\app\presenters/templates/Homepage/download.latte

use Latte\Runtime as LR;

class Template5e0fa688cf extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
    ...
    <p><a href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 11 */ ?>/res/testApk.apk" class="btn btn-success"><i class="fas fa-download"></i> Stáhnout</a></p>
    <hr>
